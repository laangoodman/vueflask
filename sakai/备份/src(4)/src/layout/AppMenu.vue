...
const model = ref([
    {
        ...
        items: [{
            ...
            items: [
                ...
                {label: '场地租用',icon: 'pi pi-fw pi-bookmark',to:'/FieldsBooking'},

                {label: '商品销售',icon: 'pi pi-fw pi-bookmark',to:'/GoodsSales'},
                {label: '次卡销售',icon: 'pi pi-fw pi-bookmark',to:'/CardsSales'},
                {label: '门票销售',icon: 'pi pi-fw pi-bookmark',to:'/TicketsSales'},
                {label: '场地状态',icon: 'pi pi-fw pi-bookmark',to:'/FieldsVacancy'},
                {label: '快速核销',icon: 'pi pi-fw pi-bookmark',to:'/WriteOffs'},
                {label: '会员扣次',icon: 'pi pi-fw pi-bookmark',to:'/CardRecords'},
            ]
        }]
    },
    {
        ...
        items: [{
            ...
            items: [
                {label: '会员卡类别',icon: 'pi pi-fw pi-bookmark',to:'/MembershipClass'},
                {label: '会员等级',icon: 'pi pi-fw pi-bookmark',to:'/MembershipLevel'},
                {label: '会员列表',icon: 'pi pi-fw pi-bookmark',to:'/MemberList'},
                {label: '会员信息',icon: 'pi pi-fw pi-bookmark',to:'/MemberInfo'},
            ]
        }]
    },
    {
        ...
        items: [{
            ...
            items: [
                {label: '商品列表',icon: 'pi pi-fw pi-bookmark',to:'/GoodsList'},
                {label: '商品类型',icon: 'pi pi-fw pi-bookmark',to:'/GoodsTypes'},
    ...
    },
    {
        ...
        items: [{
            ...
            items: [
                {label: '场地列表',icon: 'pi pi-fw pi-bookmark',to:'/FieldsList'},
                {label: '计费规则',icon: 'pi pi-fw pi-bookmark',to:'/BillingRules'},
                {label: '设备管理',icon: 'pi pi-fw pi-bookmark',to:'/DeviceManagement'}
            ]
        }]
    },
    {
        ...
        items: [{
            ...
            items: [
                {label: '单据管理',icon: 'pi pi-fw pi-bookmark',to:'/DocumentsManagement'}
            ]
        }]
    },
    {
        ...
        items: [{
            ...
            items: [
                {label: '智能设备',icon: 'pi pi-fw pi-bookmark',to:'/SmartDevices'},
                {label: '设备运维',icon: 'pi pi-fw pi-bookmark',to:'/DeviceMaintainance'},
                {label: '设备日志',icon: 'pi pi-fw pi-bookmark',to:'/DeviceLog'},
                {label: '智能灯',icon: 'pi pi-fw pi-bookmark',to:'/SmartLights'},
            ]
        }]
    },
    {
        ...
        items: [{
            ...
            items: [
                {label: '库存列表',icon: 'pi pi-fw pi-bookmark',to:'/InventoryList'}
            ]
        }]
    },
    {
        ...
        items: [{
            ...
            items: [
                {label: '优惠券',icon: 'pi pi-fw pi-bookmark',to:'/Coupon'}
            ]
        }]
    },
    {
        ...
        items: [{
            ...
            items: [
                {label: '演出/赛事信息',icon: 'pi pi-fw pi-bookmark',to:'/EventInfo'},
                {label: '场次管理',icon: 'pi pi-fw pi-bookmark',to:'/SessionManagement'},
                {label: '座位管理',icon: 'pi pi-fw pi-bookmark',to:'/Seats'},
                {label: '座位销售管理',icon: 'pi pi-fw pi-bookmark',to:'/SeatsSales'},
                {label: '票档管理',icon: 'pi pi-fw pi-bookmark',to:'/Tickets'}
            ]
        }]
    },
    // {
